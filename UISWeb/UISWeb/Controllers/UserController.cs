...
namespace UISWeb.Controllers
{
    public class UserController : Controller
    {
        ...
        public UserController(UISWebContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            var user = await _context.User.SingleOrDefaultAsync(m => m.Email == id);
            if (user == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Email")] User user)
        {
            if (id != user.Email)
            {
                return NotFound();
